...
class SpareDealerUpdateView(UpdateView):
    ...
    def get_success_url(self):
        ...
        return reverse("spare_dealer:detail", kwargs={"pk": self.object.pk})
...
class MechanicUpdateView(UpdateView):
    ...
    def get_success_url(self):
        """Reverse to detail page after successful update."""
        return reverse("mechanic:detail", kwargs={"pk": self.object.pk})
...
class CarOwnerUpdateView(UpdateView):
    ...
    def get_success_url(self):
        """Reverse to detail page after successful update."""
        return reverse("car_owner:detail", kwargs={"pk": self.object.pk})
